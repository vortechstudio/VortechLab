    ...
    <div class="row">
        <div class="col-sm-12 col-lg-4 mb-10 bg-light p-5">
            <div class="menu menu-rounded menu-column menu-active-bg menu-hover-bg menu-title-gray-700 fs-5 fw-semibold" id="aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a href="{{ route('accountCenter.setting.privacy') }}" class="menu-link active border-3 border-start border-primary">
                ...
                <div class="menu-item">
                    <a href="{{ route('accountCenter.setting.blacklist') }}" class="menu-link border-3 border-start border-transparent">
                        <span class="menu-icon">
