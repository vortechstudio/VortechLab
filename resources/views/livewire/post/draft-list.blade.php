    ...
    <div class="card-header">
        <div class="card-title">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#texte">Texte</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#images">Images</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#videos">Vidéo</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="texte" role="tabpanel">
                @foreach($texte as $text)
                    <a href="{{ route('posts.draft.edit', $text->id) }}" wire:navigate class="card shadow-lg mb-5">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{ $text->img_file ? json_decode($text->img_file, true)[0] : '' }}" alt="" class="img-fluid rounded-start"/>
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
